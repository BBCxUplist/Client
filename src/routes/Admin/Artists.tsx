...
import { Music, UserCheck, UserX, Shield, Star } from "lucide-react";
...
export const Artists = () => {
    ...
    switch (activeTab) {
      ...
      case "pending":
        return allArtists.filter(
          artist => !artist.isBookable && artist.appealStatus === "pending"
        );
      case "banned":
  ...
  const tabs = [
    { id: "all", label: "All Artists", count: allArtists.length },
    {
      id: "approved",
      label: "Approved",
      count: allArtists.filter(a => a.isBookable).length,
    },
    {
      id: "pending",
      label: "Pending",
      count: allArtists.filter(
        a => !a.isBookable && a.appealStatus === "pending"
      ).length,
    },
    {
      id: "banned",
      label: "Banned",
      count: allArtists.filter(a => a.banned).length,
    },
  ] as const;
