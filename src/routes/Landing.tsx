    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-primary/10 via-background to-secondary/10 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Book Amazing
              <span className="text-primary block">Live Music</span>
            </motion.h1>
            ...
            >
              Connect with talented musicians, book secure performances, and create unforgettable experiences for your events.
            </motion.p>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Join thousands of satisfied customers who have booked amazing live music
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
