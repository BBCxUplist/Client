        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-4">
            <img
              src={
                user.avatar ||
                `https://ui-avatars.com/api/?name=${user.name}&size=60&background=random`
              }
              alt={user.name}
          ...
          return (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-6">
                Your artist profile has been approved and you can now accept
                bookings.
              </p>
              <Link
        ...
        if (pendingAppeal) {
          return (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-6">
                Your appeal is currently being reviewed by our team. We'll
        ...
        if (rejectedAppeal) {
          return (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-6">
                Your previous appeal was not approved. You can submit a new
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-medium text-yellow-800">
                Profile Not Yet Approved
              </h3>
              <p className="text-sm text-yellow-700">
                Your artist profile is pending approval. You cannot accept
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                See how your profile appears to users
              </p>
            </div>
          </Link>
          ...
          <button className="flex items-center space-x-3 p-4 bg-card border border-border rounded-lg hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Update your bio, photos, and availability
              </p>
            </div>
          </button>
        </div>
