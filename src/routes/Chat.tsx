...
import { useArtistById, useArtists } from "@/hooks/useArtists";
                ...
                >
                  <div className="flex items-start space-x-3">
                    <img
                      src={
                        artist.avatar ||
                        `https://ui-avatars.com/api/?name=${artist.name}&size=50&background=random`
                      }
                      alt={artist.name}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(conversation.status)}`}
                        >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <img
                      src={
                        ...
                        `https://ui-avatars.com/api/?name=${currentArtist.name}&size=50&background=random`
                      }
