    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center space-x-2 text-neutral-600 hover:text-neutral-800 transition-colors mb-4"
          >
            <ArrowLeft className="h-4 w-4" />
            <span>Back</span>
          </button>
          <h1 className="text-3xl font-bold text-neutral-800">Book Artist</h1>
        </div>
          ...
          <div className="lg:col-span-2">
            {step === 'details' && (
              ...
              >
                ...
                <form onSubmit={bookingForm.handleSubmit(handleSubmitDetails)} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min={artist.price}
                        step="0.01"
                        className="w-full pl-8 pr-3 py-2 border border-input rounded-md bg-white text-neutral-800 focus:outline-none focus:ring-2 focus:ring-ring"
                      />
                    </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-4 bg-orange-500 text-white rounded-md font-medium hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring transition-colors"
                  >
                    Continue to Payment
                  </button>
                </form>
                ...
                <div className="space-y-6">
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-neutral-800">{artist.name}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-2 px-4 border border-input bg-white text-neutral-800 rounded-md font-medium hover:bg-accent hover:text-accent-foreground transition-colors"
                    >
                      Back to Details
                    </button>
                  </div>
            ...
            {step === 'success' && (
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                className="bg-white border-2 border-neutral-200 rounded-3xl shadow-md p-6 text-center"
              >
                <div className="mb-6">
              ...
              <div className="mt-4 pt-4 border-t border-border">
                <div className="flex flex-wrap gap-1">
                  {artist.tags.slice(0, 3).map((tag, index) => (
                    <span
                      key={index}
                      className="px-2 py-1 bg-muted text-neutral-600 rounded-full text-xs"
                    >
                      {tag}
                    </span>
                  ))}
