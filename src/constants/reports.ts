...
export const reports: Report[] = [
  {
    ...
    details: 'The artist was unprofessional during our initial conversation and made inappropriate comments.',
    status: 'open',
  ...
  },
  {
    ...
    targetType: 'user',
    reason: 'Harassment',
    details: 'The user has been sending harassing messages and making inappropriate requests.',
    status: 'open',
