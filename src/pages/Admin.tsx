      ...
      <div className="w-full max-w-md p-4">
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  <img src="/icons/eyeOpen.png" alt="eye" className="w-5 h-5 invert" />
                ) : (
                  <img src="/icons/eyeClosed.png" alt="eye-off" className="w-5 h-5 invert" />
                )}
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 p-4 border border-white/10 bg-white/5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white/80 text-sm mb-2 font-semibold">Security Notice</p>
              <p className="text-white/60 text-xs leading-relaxed">
                All admin access attempts are logged and monitored. Unauthorized access attempts will be reported to system administrators.
              </p>
            </div>
          </div>
        </div>
