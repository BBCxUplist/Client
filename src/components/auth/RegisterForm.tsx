...
export const RegisterForm = ({ onSubmit, isLoading, isArtist, onToggleRole }: RegisterFormProps) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="reg-email" className="block text-sm font-semibold text-neutral-700 mb-3">
          Email Address
        </label>
        <input
          {...form.register('email')}
      ...
      <div>
        <label htmlFor="reg-password" className="block text-sm font-semibold text-neutral-700 mb-3">
          Password
        </label>
      ...
      <div>
        <label htmlFor="confirm-password" className="block text-sm font-semibold text-neutral-700 mb-3">
          Confirm Password
        </label>
        <div className="relative">
          <input
