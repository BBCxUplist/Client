          ...
          >
            ...
            <div className='flex items-center justify-between mb-6'>
              <h3 className='text-xl font-semibold text-white font-mondwest'>
                {showResetOTP ? 'Reset Password' : 'Change Password'}
              </h3>
              <button
                onClick={onClose}
            ...
            {/* OTP view — replaces form when reset flow is triggered */}
            {showResetOTP ? (
              <ResetPasswordOTP
                email={userEmail}
                onBack={() => setShowResetOTP(false)}
              />
            ) : (
              <>
                {/* Success Message */}
                    ...
                    <div className='flex items-start gap-3'>
                      ...
                      <div>
                        ...
                        <p className='text-white/70 text-sm mb-3'>
                          Since you signed up with Google, we'll send you a
                          recovery code to set up a new password.
                        </p>
                        <button
                ...
                {/* Forgot current password — triggers OTP reset flow */}
                {!isGoogleUser && (
                  <div className='mt-6 pt-4 border-t border-white/10'>
                    ...
                    >
                      {isLoading ? 'Sending...' : 'Reset via Email Code'}
                    </button>
                  </div>
                )}
              </>
