  ...
  return (
    ...
    >
      ...
      <p className='text-gray-300 max-w-4xl mx-auto leading-relaxed uppercase text-lg md:text-xl lg:text-2xl'>
        <span className='font-mondwest text-orange-500 text-3xl'>Uplist</span>{' '}
        is an artist booking platform that connects talented musicians with
        people looking to hire them for events. Whether you need a singer for a{' '}
        <span className='font-mondwest text-orange-500 text-3xl '>wedding</span>
        ,{' '}
        <span className='font-mondwest text-orange-500 text-3xl'>
          birthday party
        </span>
        ,{' '}
        <span className='font-mondwest text-orange-500 text-3xl'>
        ...
        , or any other celebration, we make it simple to find and book{' '}
        <span className='font-mondwest text-orange-500 text-3xl'>
          verified artists
        </span>
        . Artists can register on our platform, get{' '}
        <span className='font-mondwest text-orange-500 text-3xl'>verified</span>
        , and receive{' '}
        <span className='font-mondwest text-orange-500 text-3xl'>
          freelance gig
        </span>{' '}
