    ...
    >
      <div>
        ...
        <p className='text-white/70'>
          Manage platform configuration and account delegation
        </p>
      </div>
          ...
          >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setNewDelegate(prev => ({ ...prev, name: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setNewDelegate(prev => ({ ...prev, email: e.target.value }))
                  }
                  className='w-full bg-white/5 border border-white/20 text-white p-2 rounded focus:border-orange-500 focus:outline-none'
            ...
            <div className='mb-4'>
              ...
              <select
                ...
                onChange={e =>
                  setNewDelegate(prev => ({ ...prev, role: e.target.value }))
                }
                className='w-full bg-white/5 border border-white/20 text-white p-2 rounded focus:border-orange-500 focus:outline-none'
              >
            ...
            >
              <div className='flex items-center justify-between mb-3'>
                ...
                <div className='flex items-center gap-3'>
                  <span
                    className={`px-2 py-1 rounded text-xs font-medium ${getStatusBg(delegate.status)} ${getStatusColor(delegate.status)}`}
                  >
                    {delegate.status}
                  </span>
                  <button
