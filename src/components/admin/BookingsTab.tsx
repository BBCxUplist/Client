...
const BookingsTab = ({ dummyBookings }: BookingsTabProps) => {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-2xl font-bold text-white mb-4">Bookings Management</h2>
        <p className="text-white/70">Monitor and manage all platform bookings</p>
      </div>
        ...
        <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{dummyBookings.length}</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-orange-400">
                {formatCurrency(dummyBookings.reduce((sum, b) => sum + b.amount, 0))}
              </p>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3 text-sm">
              ...
              <div>
                ...
                <span className="text-white font-semibold">{formatCurrency(booking.amount)}</span>
              </div>
              <div>
