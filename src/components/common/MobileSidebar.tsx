...
export const MobileSidebar = ({ isOpen, onClose, onFeaturedArtistsClick }: MobileSidebarProps) => {
            ...
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-xl font-bold font-dm-sans text-neutral-800">Menu</h2>
                </div>
                <button
                  onClick={onClose}
                ...
                >
                  <svg className="w-6 h-6 text-neutral-600 group-hover:text-neutral-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-500 group-hover:text-neutral-600">Discover amazing artists</p>
                    </div>
                  </div>
                </motion.button>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-500 group-hover:text-neutral-600">View top performers</p>
                    </div>
                  </div>
                </motion.button>
              </nav>
              ...
              >
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-4 text-white">
                  ...
                  <p className="text-orange-100 text-sm mb-4">Join thousands of satisfied customers</p>
                  <button 
